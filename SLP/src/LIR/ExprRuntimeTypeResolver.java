...
public class ExprRuntimeTypeResolver implements PropagatingVisitor<Object, Object> {
	private SymbolTable symTab;
	private TypeTable typTab;
	private String currentThisClass;
	private String currentMethodName;
	
	public ExprRuntimeTypeResolver(SymbolTable symtab, TypeTable typtab, String currentThisClass, String currentMethodName) {
	...
	public Object visit(VarLocation varLoc, Object d) {
		...
		// local
			...
			if (sym == null){
				sym = symTab.findEntryGlobal("__p_"+varLoc.name);
			}
			if(sym.runtimeType != null)
				return sym.runtimeType;
		}		
